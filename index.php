...
<head>
	...
	<title>Sistem Informasi Kependudukan Perumahan Walikota RT04 </title>
	...
	<div class="wrapper">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<font color="white">
							<b>SISTEM INFORMASI DATA KEPENDUDUKAN PERUMAHAN WALIKOTA RT04</b>
						</font>
					</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text">SISTEM PENDUDUK</span>
			</a>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Copyright &copy;
				<a target="_blank" href="https://www.instagram.com/piero_4020?utm_source=qr&igsh=MTFwaDQ4aGx2bmp1eA==">
					<strong> piero_4020</strong>
				</a>
				All rights reserved.
			</div>
		</footer>
